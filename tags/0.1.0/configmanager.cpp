...
bool ConfigManager::load()
{
	...
	m_confBool[USE_COOLDOWNS] = getGlobalBool("useCooldowns", true);
	...
	m_confBool[ENABLE_CAP] = getGlobalBool("enableCapacity", true);
#ifdef __TCS_VIP__
	m_confBool[INIT_VIP_UPDATE] = getGlobalBool("updateVipDaysAtStartup", true);
	m_confBool[FREE_VIP] = getGlobalBool("freeVipDays", false);
#endif
