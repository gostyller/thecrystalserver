		...
		inline void addType(T add)
		{
			if((bufferSize - size) < sizeof(T))
			{
				...
				if(tmp != NULL)
					...
					std::cout << "[Error - PropWriteStream::addType] Failed to allocate memory" << std::endl;
			}
		...
		inline void addStruct(T* add)
		{
			if((bufferSize - size) < sizeof(T))
			{
				...
				if(tmp != NULL)
					...
					std::cout << "[Error - PropWriteStream::addStruct] Failed to allocate memory" << std::endl;
			}
		...
		inline void addString(const std::string& add)
		{
			...
			if((bufferSize - size) < strLen)
			{
				...
				if(tmp != NULL)
					...
					std::cout << "[Error - PropWriteStream::addString] Failed to allocate memory" << std::endl;
			}
		...
		inline void addLongString(const std::string& add)
		{
			...
			if((bufferSize - size) < strLen)
			{
				...
				if(tmp != NULL)
					...
					std::cout << "[Error - PropWriteStream::addLongString] Failed to allocate memory" << std::endl;
			}
