...
bool Npc::loadFromXml(const std::string& filename)
{
	...
	if(readXMLInteger(root, "autowalk", intValue))
		std::cout << "[Notice - Npc::Npc] NPC: " << name << " - autowalk attribute has been deprecated, use walkinterval instead." << std::endl;
	...
	m_npc(npc), m_interface(npc->getInterface())
{
	...
	{
		std::cout << "[Warning - NpcEvents::NpcEvents] Cannot load script: " << file
...
void NpcEvents::onCreatureAppear(const Creature* creature)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onCreatureAppear] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onCreatureDisappear(const Creature* creature)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onCreatureDisappear] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onCreatureMove(const Creature* creature, const Position& oldPos, const Position& newPos)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onCreatureMove] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onCreatureSay(const Creature* creature, SpeakClasses type, const std::string& text, Position* /*pos = NULL*/)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onCreatureSay] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
	...
	uint8_t count, uint8_t amount, bool ignoreCap, bool inBackpacks)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onPlayerTrade] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onPlayerCloseChannel(const Player* player)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onPlayerCloseChannel] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onPlayerEndTrade(const Player* player)
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onPlayerEndTrade] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
...
void NpcEvents::onThink()
{
	...
	if(m_interface->reserveEnv())
	{
		...
		std::cout << "[Error - NpcEvents::onThink] NPC Name: " << m_npc->getName() << " - Call stack overflow" << std::endl;
}
