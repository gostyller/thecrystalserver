...
bool ProtocolLogin::parseFirstPacket(NetworkMessage& msg)
{
	...
	Account account = IOManager::getInstance()->loadAccount(id);
	...
	if(IOBan::getInstance()->getData(ban) && !IOManager::getInstance()->hasFlag(account.number, PlayerFlag_CannotBeBanned))
	{
	...
	// remove premium days
	IOManager::getInstance()->removePremium(account);
