...
function onUse(cid, item, frompos, item2, topos)
   	if item.uid == 9500 then
   		...
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_INFO_DESC,"You have found a Arcane staff.")
   	...
   	elseif item.uid == 9501 then
   		queststatus = getPlayerStorageValue(cid,8742)
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_INFO_DESC,"You have found a Avenger.")
   	...
   	elseif item.uid == 9502 then
   		queststatus = getPlayerStorageValue(cid,8742)
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_INFO_DESC,"You have found a Arbalest.")
