...
class NetworkMessage
{
	public:
		...
		// message propeties functions
	  	...
	  	int32_t getMessageLength() const { return m_size; }
		...
		int32_t getReadPos() const { return m_position; }
		uint8_t  GetByte(){return m_buffer[m_position++];}

		char* buffer() {return (char*)&m_buffer[0];}
		char* getBuffer() { return (char*)&m_buffer[0]; }
		char* bodyBuffer()
		{
