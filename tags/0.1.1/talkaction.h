...
class TalkAction : public Event
{
	...
	protected:
		...
		static TalkFunction addPremiumDays;
		static TalkFunction reloadInfo;
		static TalkFunction setWorldType;
		static TalkFunction addBless;
		static TalkFunction addAddon;
		static TalkFunction saveServer;
		static TalkFunction addSkill;
		static TalkFunction checkPvpType;
		static TalkFunction sendBugReport;
		static TalkFunction showExp;
		static TalkFunction showMana;
