...
CHANNEL_GAMECHAT = 5
CHANNEL_TRADE = 6
CHANNEL_ADVERTSE = CHANNEL_TRADE
CHANNEL_TRADEROOK = 7
CHANNEL_ADVERTSEROOK = CHANNEL_TRADEROOK
CHANNEL_RLCHAT = 8
...
isMonsterName = getMonsterName
isNpcName = getNpcName
getPlayerManaSpent = getPlayerSpentMana
doPlayerAddManaSpent = doPlayerAddSpentMana
doAccountSave = doSaveAccount
