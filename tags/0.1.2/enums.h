...
{
	EXHAUST_OTHER = 0,
	EXHAUST_SPELLGROUP_NONE = 0x01,
	EXHAUST_SPELLGROUP_ATTACK = 0x02,
	EXHAUST_SPELLGROUP_HEALING = 0x03,
	EXHAUST_SPELLGROUP_SUPPORT = 0x04,
	EXHAUST_SPELLGROUP_SPECIAL = 0x05,
	EXHAUST_MELEE = 0x06
};
