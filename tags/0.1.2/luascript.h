...
class LuaInterface
{
	...
	protected:
		...
		static int32_t luaDoAccountSave(lua_State* L);
		...
		static const luaL_Reg luaStdTable[8];
		...
		static int32_t luaIsNpcName(lua_State* L);
		static int32_t luaIsMonsterName(lua_State* L);
		
		static int32_t luaGetHouseTilesCount(lua_State* L);
		static int32_t luaGetHouseDoorCount(lua_State* L);
		static int32_t luaGetHouseBedCount(lua_State* L);
