...
bool TalkAction::software(Creature* creature, const std::string&, const std::string&)
{
	...
	player->sendTextMessage(MSG_STATUS_CONSOLE_BLUE, "Crystal Server - Version 0.1.2 (Ice Fenix).");
	return true;
}

bool TalkAction::addPremiumDays(Creature*, const std::string&, const std::string& param)
{
...
bool TalkAction::reloadInfo(Creature* creature, const std::string&, const std::string& param)
{
	Player* player = creature->getPlayer();
	if(player)
	{
...
bool TalkAction::setWorldType(Creature* creature, const std::string&, const std::string& param)
{
	Player* player = creature->getPlayer();
	if(!player)
		return false;
...
bool TalkAction::checkPvpType(Creature* creature, const std::string&, const std::string& param)
{
	Player* player = creature->getPlayer();
	if(!player)
		return false;
...
bool TalkAction::addBless(Creature*, const std::string&, const std::string& param)
{
	std::string name;
	int32_t blessId = 0;
	std::istringstream in(param.c_str());
...
bool TalkAction::addAddon(Creature* creature, const std::string&, const std::string& param)
{
...
bool TalkAction::saveServer(Creature* creature, const std::string&, const std::string& param)
{
 	Player* player = creature->getPlayer();
