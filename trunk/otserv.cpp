...
bool argumentsHandler(StringVec args)
{
	...
	for(StringVec::iterator it = args.begin(); it != args.end(); ++it)
	{
		...
		{
			std::clog << ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" << std::endl;
			std::clog << ":: Crystal Server - Version: 1.0.5 ::::::::::::::::::::::::::::::::::::::::::::" << std::endl;
...
int main(int argc, char* argv[])
{
	...
	{
		Status::getInstance();
		std::clog << ":: " << g_config.getString(ConfigManager::SERVER_NAME) << " Online!" << std::endl << std::endl;
		servicer.run();
	}
	else
		std::clog << ":: " << g_config.getString(ConfigManager::SERVER_NAME) << " Offline! No services available..." << std::endl << std::endl;
...
void otserv(StringVec, ServiceManager* services)
{
	...
	std::clog << std::endl << ":: Server is starting up..." << std::endl;
